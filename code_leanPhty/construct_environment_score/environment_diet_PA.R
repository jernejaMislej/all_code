...
#
VIP_data_independant_complete_cases$bmi_environment_score_fitted<-full_model$fitted.values
...
#
#
VIP_data_subset_visit1_complete_cases$bmi_environment_score_fitted<-full_model$fitted.values
VIP_data_subset_visit1_complete_cases$lifestyle_induced_weight_gain_residuals<-full_model$residuals+10
...
VIP_data_subset_visit2_complete_cases$lifestyle_induced_weight_gain_residuals<-full_model$residuals+10
