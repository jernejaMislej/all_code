...
VIP_data_independant_complete_cases$utbild<-VIP_data_independant[VIP_data_independant$enummer %in% VIP_data_independant_complete_cases$enummer,"utbild"]
...
full_model<-lm(log(bmi)~age + agesq + gender_factor + year + ffq_factor + POLYsum1_TEI_adjusted_norm_sd+MONOsum1_TEI_adjusted_norm_sd+mfetsum1_TEI_adjusted_norm_sd+
				...
				alkosum1_TEI_adjusted_norm_sd+utbild, data = VIP_data_independant_complete_cases)
summary(full_model)
vif(full_model)
...
selected_model<-lm(log(bmi)~age + agesq + gender_factor + year + ffq_factor + POLYsum1_TEI_adjusted_norm_sd+MONOsum1_TEI_adjusted_norm_sd+mfetsum1_TEI_adjusted_norm_sd+
				...
				protsum1_anim_TEI_adjusted_norm_sd+protsum1_veg_TEI_adjusted_norm_sd+fibesum1_TEI_adjusted_norm_sd+
				DISAsum1_TEI_adjusted_norm_sd + TRANSsum1_TEI_adjusted_norm_sd+
...
bmi_classes_independent<-bmi_classes_independent[!is.na(VIP_data_independant_complete_cases$utbild),]
...
selected_variables<-c("age","agesq","gender_factor","year","ffq_factor","POLYsum1_TEI_adjusted_norm_sd","MONOsum1_TEI_adjusted_norm_sd","mfetsum1_TEI_adjusted_norm_sd",
		...
		"protsum1_veg_TEI_adjusted_norm_sd","DISAsum1_TEI_adjusted_norm_sd","TRANSsum1_TEI_adjusted_norm_sd","NATRsum1_TEI_adjusted_norm_sd","fibesum1_TEI_adjusted_norm_sd",
...
#construct and save the continuous and discrete phenotypes......caution messy code in the loading script
...
write.table(final_dataset, "../Results/persistantly_lean_subjects/final_persistant_phenotype_dataset_final.phen", row.names=FALSE,sep="\t",na="NA")
