...
case_01_control_compliant_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_01_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_01_control_compliant) & VIP_data_subset_visit1_complete_cases$case_01_control_compliant==0
				& VIP_data_subset_visit2_complete_cases$case_01_control_compliant==0]
case_01_control_compliant_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_01_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_01_control_compliant) & VIP_data_subset_visit1_complete_cases$case_01_control_compliant==1
				& VIP_data_subset_visit2_complete_cases$case_01_control_compliant==1]
case_01_control_compliant_enummers<-c(case_01_control_compliant_enummers_0,case_01_control_compliant_enummers_1)
case_01_control_compliant_data<-VIP_data_subset_visit1_complete_cases$case_01_control_compliant
case_01_control_compliant_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_01_control_compliant_enummers)]<-"NA"

#case_02_control_compliant
case_02_control_compliant_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_02_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_02_control_compliant) & VIP_data_subset_visit1_complete_cases$case_02_control_compliant==0
				& VIP_data_subset_visit2_complete_cases$case_02_control_compliant==0]
case_02_control_compliant_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_02_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_02_control_compliant) & VIP_data_subset_visit1_complete_cases$case_02_control_compliant==1
				& VIP_data_subset_visit2_complete_cases$case_02_control_compliant==1]
case_02_control_compliant_enummers<-c(case_02_control_compliant_enummers_0,case_02_control_compliant_enummers_1)
case_02_control_compliant_data<-VIP_data_subset_visit1_complete_cases$case_02_control_compliant
case_02_control_compliant_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_02_control_compliant_enummers)]<-"NA"

#case_10_control_compliant
case_10_control_compliant_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_10_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_10_control_compliant) & VIP_data_subset_visit1_complete_cases$case_10_control_compliant==0
				& VIP_data_subset_visit2_complete_cases$case_10_control_compliant==0]
case_10_control_compliant_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_10_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_10_control_compliant) & VIP_data_subset_visit1_complete_cases$case_10_control_compliant==1
				& VIP_data_subset_visit2_complete_cases$case_10_control_compliant==1]
case_10_control_compliant_enummers<-c(case_10_control_compliant_enummers_0,case_10_control_compliant_enummers_1)
case_10_control_compliant_data<-VIP_data_subset_visit1_complete_cases$case_10_control_compliant
case_10_control_compliant_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_10_control_compliant_enummers)]<-"NA"

#case_12_control_compliant
case_12_control_compliant_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_12_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_12_control_compliant) & VIP_data_subset_visit1_complete_cases$case_12_control_compliant==0
				& VIP_data_subset_visit2_complete_cases$case_12_control_compliant==0]
case_12_control_compliant_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_12_control_compliant) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_12_control_compliant) & VIP_data_subset_visit1_complete_cases$case_12_control_compliant==1
				& VIP_data_subset_visit2_complete_cases$case_12_control_compliant==1]
case_12_control_compliant_enummers<-c(case_12_control_compliant_enummers_0,case_12_control_compliant_enummers_1)
case_12_control_compliant_data<-VIP_data_subset_visit1_complete_cases[VIP_data_subset_visit1_complete_cases$enummer %in% case_12_control_compliant_enummers,"case_12_control_compliant"]
case_12_control_compliant_data<-VIP_data_subset_visit1_complete_cases$case_12_control_compliant
case_12_control_compliant_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_12_control_compliant_enummers)]<-"NA"
...
final_dataset<-data.frame(matrix(ncol=11,nrow=length(enummers_total)))
colnames(final_dataset)<-c("glacier_ID", "pat_code_dna", "resistance_phenotype", "resistance_case_control_susceptible", "resistance_case_control_compliant", 
		"susceptible_case_control_compliant", "case_01_control_compliant", "case_02_control_compliant", "case_12_control_compliant", "case_10_control_compliant","bmi_log")
...
final_dataset$resistance_phenotype<-(VIP_data_subset_visit1_complete_cases$resistance_continuous[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total]+
...
final_dataset$case_01_control_compliant<-as.numeric(case_01_control_compliant_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_02_control_compliant<-as.numeric(case_02_control_compliant_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_12_control_compliant<-as.numeric(case_12_control_compliant_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_10_control_compliant<-as.numeric(case_10_control_compliant_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
...
write.table(final_dataset, "../final_persistant_phenotype_dataset_1309.phen", row.names=FALSE,sep="\t",na="NA")




#the results are not so good for the resistant ones, therefore the limits are changed a bit, having normal weight up to 28 BMI and other things
#visit1
...
#susceptible
VIP_data_subset_visit1_complete_cases$resistance_case_control_susceptible_2[(predicted_values_visit1$fit<log(28) & VIP_data_subset_visit1_complete_cases$bmi>=28)
...
#-------------01_case_control_compliant_00-------------------
VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==0)]<-0
#01
VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00[(predicted_categorized_visit1==1 & VIP_data_subset_visit1_complete_cases$bmi_category==0)& VIP_data_subset_visit1_complete_cases$sm_status!=1 
				& !is.na(VIP_data_subset_visit1_complete_cases$sm_status)]<-1
#-------------01_case_control_compliant_00-------------------

#-------------02_case_control_compliant_00-------------------
VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==0)]<-0
#02
VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00[(predicted_categorized_visit1==2 & VIP_data_subset_visit1_complete_cases$bmi_category==0)& VIP_data_subset_visit1_complete_cases$sm_status!=1 
				& !is.na(VIP_data_subset_visit1_complete_cases$sm_status)]<-1
#-------------01_case_control_compliant_00-------------------

#-------------10_case_control_compliant_00-------------------
VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==0)]<-0
#10
VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==1)& VIP_data_subset_visit1_complete_cases$sm_status!=2 
				& !is.na(VIP_data_subset_visit1_complete_cases$sm_status)]<-1
#-------------10_case_control_compliant_00-------------------

#-------------12_case_control_compliant_00-------------------
VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==0)]<-0
#12
VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00[(predicted_categorized_visit1==1 & VIP_data_subset_visit1_complete_cases$bmi_category==2)& VIP_data_subset_visit1_complete_cases$sm_status!=1 
				& !is.na(VIP_data_subset_visit1_complete_cases$sm_status)]<-1
#-------------12_case_control_compliant_00-------------------

#-------------11_case_control_compliant_00-------------------
VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==0)]<-0
#12
VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00[(predicted_categorized_visit1==1 & VIP_data_subset_visit1_complete_cases$bmi_category==1)]<-1
#-------------11_case_control_compliant_00-------------------

#-------------22_case_control_compliant_00-------------------
VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00[(predicted_categorized_visit1==0 & VIP_data_subset_visit1_complete_cases$bmi_category==0)]<-0
#12
VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00[(predicted_categorized_visit1==2 & VIP_data_subset_visit1_complete_cases$bmi_category==2)]<-1
#-------------22_case_control_compliant_00-------------------
...
#susceptible
VIP_data_subset_visit2_complete_cases$resistance_case_control_susceptible_2[(predicted_values_visit2$fit<log(28) & VIP_data_subset_visit2_complete_cases$bmi>=28)
...
#-------------01_case_control_compliant_00-------------------
VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==0)]<-0
#01
VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00[(predicted_categorized_visit2==1 & VIP_data_subset_visit2_complete_cases$bmi_category==0)& VIP_data_subset_visit2_complete_cases$sm_status!=1 
				& !is.na(VIP_data_subset_visit2_complete_cases$sm_status)]<-1
#-------------01_case_control_compliant_00-------------------

#-------------02_case_control_compliant_00-------------------
VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==0)]<-0
#02
VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00[(predicted_categorized_visit2==2 & VIP_data_subset_visit2_complete_cases$bmi_category==0)& VIP_data_subset_visit2_complete_cases$sm_status!=1 
				& !is.na(VIP_data_subset_visit2_complete_cases$sm_status)]<-1
#-------------01_case_control_compliant_00-------------------

#-------------10_case_control_compliant_00-------------------
VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==0)]<-0
#10
VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==1)& VIP_data_subset_visit2_complete_cases$sm_status!=2 
				& !is.na(VIP_data_subset_visit2_complete_cases$sm_status)]<-1
#-------------10_case_control_compliant_00-------------------

#-------------12_case_control_compliant_00-------------------
VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==0)]<-0
#12
VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00[(predicted_categorized_visit2==1 & VIP_data_subset_visit2_complete_cases$bmi_category==2)& VIP_data_subset_visit2_complete_cases$sm_status!=1 
				& !is.na(VIP_data_subset_visit2_complete_cases$sm_status)]<-1
#-------------12_case_control_compliant_00-------------------

#-------------11_case_control_compliant_00-------------------
VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==0)]<-0
#12
VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00[(predicted_categorized_visit2==1 & VIP_data_subset_visit2_complete_cases$bmi_category==1)]<-1
#-------------11_case_control_compliant_00-------------------

#-------------22_case_control_compliant_00-------------------
VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00<-empty_vector
#compliant
VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00[(predicted_categorized_visit2==0 & VIP_data_subset_visit2_complete_cases$bmi_category==0)]<-0
#12
VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00[(predicted_categorized_visit2==2 & VIP_data_subset_visit2_complete_cases$bmi_category==2)]<-1
#-------------22_case_control_compliant_00-------------------
...
#middle bmi
VIP_data_subset_visit1_complete_cases$case_bmi_low_control_bmi_middle[log(VIP_data_subset_visit1_complete_cases$bmi)<upper_lim & 
...
#middle bmi
VIP_data_subset_visit2_complete_cases$case_bmi_low_control_bmi_middle[log(VIP_data_subset_visit2_complete_cases$bmi)<upper_lim & 
...
#case_01_control_compliant_00
case_01_control_compliant_00_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00==0
				& VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00==0]
case_01_control_compliant_00_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00==1
				& VIP_data_subset_visit2_complete_cases$case_01_control_compliant_00==1]
case_01_control_compliant_00_enummers<-c(case_01_control_compliant_00_enummers_0,case_01_control_compliant_00_enummers_1)
case_01_control_compliant_00_data<-VIP_data_subset_visit1_complete_cases$case_01_control_compliant_00
case_01_control_compliant_00_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_01_control_compliant_00_enummers)]<-"NA"

#case_02_control_compliant_00
case_02_control_compliant_00_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00==0
				& VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00==0]
case_02_control_compliant_00_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00==1
				& VIP_data_subset_visit2_complete_cases$case_02_control_compliant_00==1]
case_02_control_compliant_00_enummers<-c(case_02_control_compliant_00_enummers_0,case_02_control_compliant_00_enummers_1)
case_02_control_compliant_00_data<-VIP_data_subset_visit1_complete_cases$case_02_control_compliant_00
case_02_control_compliant_00_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_02_control_compliant_00_enummers)]<-"NA"

#case_12_control_compliant_00
case_12_control_compliant_00_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00==0
				& VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00==0]
case_12_control_compliant_00_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00==1
				& VIP_data_subset_visit2_complete_cases$case_12_control_compliant_00==1]
case_12_control_compliant_00_enummers<-c(case_12_control_compliant_00_enummers_0,case_12_control_compliant_00_enummers_1)
case_12_control_compliant_00_data<-VIP_data_subset_visit1_complete_cases$case_12_control_compliant_00
case_12_control_compliant_00_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_12_control_compliant_00_enummers)]<-"NA"

#case_10_control_compliant_00
case_10_control_compliant_00_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00==0
				& VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00==0]
case_10_control_compliant_00_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00==1
				& VIP_data_subset_visit2_complete_cases$case_10_control_compliant_00==1]
case_10_control_compliant_00_enummers<-c(case_10_control_compliant_00_enummers_0,case_10_control_compliant_00_enummers_1)
case_10_control_compliant_00_data<-VIP_data_subset_visit1_complete_cases$case_10_control_compliant_00
case_10_control_compliant_00_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_10_control_compliant_00_enummers)]<-"NA"

#case_11_control_compliant_00
case_11_control_compliant_00_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00==0
				& VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00==0]
case_11_control_compliant_00_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00==1
				& VIP_data_subset_visit2_complete_cases$case_11_control_compliant_00==1]
case_11_control_compliant_00_enummers<-c(case_11_control_compliant_00_enummers_0,case_11_control_compliant_00_enummers_1)
case_11_control_compliant_00_data<-VIP_data_subset_visit1_complete_cases$case_11_control_compliant_00
case_11_control_compliant_00_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_11_control_compliant_00_enummers)]<-"NA"

#case_22_control_compliant_00
case_22_control_compliant_00_enummers_0<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00==0
				& VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00==0]
case_22_control_compliant_00_enummers_1<-VIP_data_subset_visit1_complete_cases$enummer[!is.na(VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00) 
				& !is.na(VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00) & VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00==1
				& VIP_data_subset_visit2_complete_cases$case_22_control_compliant_00==1]
case_22_control_compliant_00_enummers<-c(case_22_control_compliant_00_enummers_0,case_22_control_compliant_00_enummers_1)
case_22_control_compliant_00_data<-VIP_data_subset_visit1_complete_cases$case_22_control_compliant_00
case_22_control_compliant_00_data[!(VIP_data_subset_visit1_complete_cases$enummers %in% case_22_control_compliant_00_enummers)]<-"NA"


#glacier_id  persistant phenotype  identifierC1 identifierC2 ....
final_dataset<-data.frame(matrix(ncol=25,nrow=length(enummers_total)))
colnames(final_dataset)<-c("glacier_ID", "pat_code_dna", "resistance_phenotype", "resistance_case_control_susceptible", "resistance_case_control_compliant", 
		"susceptible_case_control_compliant", "case_01_control_compliant", "case_02_control_compliant", "case_12_control_compliant", "case_10_control_compliant","bmi_log",
		"resistance_case_control_susceptible_2", "resistance_case_control_compliant_2", "susceptible_case_control_compliant_2","case_11_control_compliant_00",
		"case_22_control_compliant_00","case_12_control_compliant_00","case_10_control_compliant_00","case_01_control_compliant_00","case_02_control_compliant_00",
		"case_bmi_low_control_bmi_middle", "case_bmi_high_control_bmi_middle", "case_bmi_low_control_bmi_middle_2", "case_bmi_high_control_bmi_middle_2","bmi_basic_fit_log")
...
#additional six
final_dataset$case_11_control_compliant_00<-as.numeric(case_11_control_compliant_00_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_12_control_compliant_00<-as.numeric(case_12_control_compliant_00_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_10_control_compliant_00<-as.numeric(case_10_control_compliant_00_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_01_control_compliant_00<-as.numeric(case_01_control_compliant_00_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
final_dataset$case_22_control_compliant_00<-as.numeric(case_22_control_compliant_00_data[VIP_data_subset_visit1_complete_cases$Subject_id %in% subject_total])
